...
export default function MapSection() {
  ...
  useEffect(() => {
    if (mapRef.current && !mapInstanceRef.current && isInView) {
      ...
      const map = L.map(mapRef.current).setView([-35.3367, 149.0929], 15);
      ...
      const marker = L.marker([-35.3367, 149.0929]).addTo(map);
      marker.bindPopup(`
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Located at the Black Mountain Rowing Club on the shores of Lake Burley Griffin, 
